-- Week 1 (Grade 1 & 4)
-- Grade 1
INSERT INTO challenges (id, topic, season, week_number, grade_level) VALUES ('ch_Spring_2025_w1_g1_Math', 'Math', 'Spring 2025', 1, 1) ON CONFLICT (id) DO NOTHING;
...
-- Grade 4
INSERT INTO challenges (id, topic, season, week_number, grade_level) VALUES ('ch_Spring_2025_w1_g4_Math', 'Math', 'Spring 2025', 1, 4) ON CONFLICT (id) DO NOTHING;
INSERT INTO questions (id, challenge_id, question_text, correct_option, wrong_option_1, wrong_option_2) VALUES 
