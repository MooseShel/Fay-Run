-- ========================================================
-- TOTAL CLEANUP & REPOPULATE (V3)
-- Grades: Pre-K 3 (-2), Pre-K 4 (-1), K (0), 1st (1), 4th (4)
-- Action: DELETES old default challenges and REPLACES with 10-level curriculum.
-- Note: Does not touch EXAMS.
-- ========================================================

BEGIN;

-- 1. CLEANUP: Remove old default progress, questions, and challenges for the target grades.
-- This ensures no mixed content, duplicates, or foreign key violations.
DELETE FROM student_progress 
WHERE challenge_id IN (
    SELECT id FROM challenges 
    WHERE grade_level IN (-2, -1, 0, 1, 4) 
    AND is_exam = FALSE
);
...
('prek3_d1', 'Math', -2, 1, FALSE), ('prek3_d2', 'Math', -2, 2, FALSE),
('prek3_d3', 'Math', -2, 3, FALSE), ('prek3_d4', 'Math', -2, 4, FALSE),
('prek3_d5', 'Science', -2, 5, FALSE), ('prek3_d6', 'Science', -2, 6, FALSE),
('prek3_d7', 'Science', -2, 7, FALSE), ('prek3_d8', 'Science', -2, 8, FALSE),
('prek3_d9', 'Social', -2, 9, FALSE), ('prek3_d10', 'Social', -2, 10, FALSE);
...
-- 3. PRE-K 4 (Grade -1) - 30 OCEAN QUESTIONS
INSERT INTO challenges (id, topic, grade_level, difficulty_level, is_exam) VALUES 
('prek4_d1', 'Ocean', -1, 1, FALSE), ('prek4_d2', 'Ocean', -1, 2, FALSE), ('prek4_d3', 'Ocean', -1, 3, FALSE),
('prek4_d4', 'Ocean', -1, 4, FALSE), ('prek4_d5', 'Ocean', -1, 5, FALSE), ('prek4_d6', 'Ocean', -1, 6, FALSE),
('prek4_d7', 'Ocean', -1, 7, FALSE), ('prek4_d8', 'Ocean', -1, 8, FALSE), ('prek4_d9', 'Ocean', -1, 9, FALSE), ('prek4_d10', 'Ocean', -1, 10, FALSE);
...
-- 4. KINDERGARTEN (Grade 0)
INSERT INTO challenges (id, topic, grade_level, difficulty_level, is_exam) VALUES 
('k_d1', 'Math', 0, 1, FALSE), ('k_d2', 'Math', 0, 2, FALSE), ('k_d3', 'Math', 0, 3, FALSE), ('k_d5', 'Science', 0, 5, FALSE), ('k_d8', 'Social', 0, 8, FALSE), ('k_d10', 'General', 0, 10, FALSE);
...
-- 5. 1st GRADE (Grade 1) - 30 MATH/MEASUREMENT QUESTIONS
INSERT INTO challenges (id, topic, grade_level, difficulty_level, is_exam) VALUES 
('g1_d1', 'Math', 1, 1, FALSE), ('g1_d2', 'Math', 1, 2, FALSE), ('g1_d3', 'Math', 1, 3, FALSE), ('g1_d4', 'Math', 1, 4, FALSE), ('g1_d5', 'Math', 1, 5, FALSE),
('g1_d6', 'Math', 1, 6, FALSE), ('g1_d7', 'Math', 1, 7, FALSE), ('g1_d8', 'Math', 1, 8, FALSE), ('g1_d9', 'Math', 1, 9, FALSE), ('g1_d10', 'Math', 1, 10, FALSE);
...
-- 6. 4th GRADE (Grade 4)
INSERT INTO challenges (id, topic, grade_level, difficulty_level, is_exam) VALUES 
('g4_d1', 'Math', 4, 1, FALSE), ('g4_d2', 'Math', 4, 2, FALSE), ('g4_d3', 'Math', 4, 3, FALSE), ('g4_d4', 'Math', 4, 4, FALSE), ('g4_d5', 'Math', 4, 5, FALSE),
('g4_d6', 'Science', 4, 6, FALSE), ('g4_d7', 'Science', 4, 7, FALSE), ('g4_d8', 'Science', 4, 8, FALSE), ('g4_d9', 'Social', 4, 9, FALSE), ('g4_d10', 'Social', 4, 10, FALSE);
