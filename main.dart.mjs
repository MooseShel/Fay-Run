...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1317: x0 => x0.createStereoPanner(),
      _1318: (x0,x1) => x0.connect(x1),
      _1319: x0 => x0.load(),
      _1320: x0 => x0.remove(),
      _1321: x0 => x0.play(),
      _1322: x0 => x0.pause(),
      ...
      _1550: (x0,x1) => new WebSocket(x0,x1),
      _1551: (x0,x1) => x0.send(x1),
      _1552: (x0,x1,x2) => x0.close(x1,x2),
      _1553: (x0,x1) => x0.close(x1),
      _1554: x0 => x0.close(),
      _1555: x0 => new BroadcastChannel(x0),
      _1556: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1556(f,arguments.length,x0) }),
      _1557: (x0,x1) => x0.postMessage(x1),
      _1558: x0 => x0.close(),
